...
interface GiFlameProps extends React.SVGProps<SVGSVGElement> {
  size?: number; // Optional size prop
  color?: string; // Optional color prop
}

export const GiFlame: React.FC<GiFlameProps> = ({ size = 24, color = "currentColor", ...props }) => (
  <svg
