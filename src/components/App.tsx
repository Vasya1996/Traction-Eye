			...
			<QueryClientProvider client={queryClient}>
				...
				<Router location={location} navigator={reactNavigator}>
					...
					{location?.pathname !== "/connect" && TEST_ADDRESSES.includes(userFriendlyAddress) && (
						...
						>
							<BottomNavigationAction icon={<div style={{paddingTop: 8}}><AssetsOff isActive={value === 0}/></div>} />
							<BottomNavigationAction icon={<div style={{paddingTop: 8}}><SocialCap isActive={value === 1}/></div>} />
						</BottomNavigation>	
					)}
				</Router>
			</QueryClientProvider>
