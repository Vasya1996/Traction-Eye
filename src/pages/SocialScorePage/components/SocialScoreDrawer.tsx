        ...
        >
            ...
            >
                ...
                <Box sx={{ position: "relative", width: "fit-content" }}>
                    <Typography
                        sx={{ color: "#1F2937", lineHeight: "20px", fontSize: "24px" }}
                        variant="h6"
                        fontWeight="bold"
                    >
                        Social Score
                    ...
                    <Tooltip
                        title={
                            <span style={{ fontSize: 9 }}>
                                Dynamic metric for the value of your contacts that
                                <br />
                                changes depending on the NetWorth of each contact
                            </span>
                        }
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ width: "24px", height: "24px", position: "absolute", top: "-4px", right: -16 }}
                        >
