  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          shareContent(`https://t.me/TractionEyebot/app?startapp=${userData?.referral_link}__wallet=${userFriendlyAddress}`,"Check out my investment profile and join my network of contacts. Find out your social score 🏆");
        }}
        sx={{
          height: "56px",
          color: '#1F2937',
